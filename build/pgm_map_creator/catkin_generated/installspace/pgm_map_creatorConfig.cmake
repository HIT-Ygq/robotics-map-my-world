...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pgm_map_creator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/workspace/where-am-i/install/${idir}'.  Ask the maintainer 'robond <haoyang@udacity.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robond/workspace/where-am-i/install/lib;/home/robond/workspace/where-am-i/devel/lib;/opt/ros/kinetic/lib)
