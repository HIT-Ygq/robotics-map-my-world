...
| **Different initial start pos**<br />The robot gets placed to another<br />place of the building (left side of the floor), but its orientation keeps<br />the same. In this case, the laser scaner does not match with the walls and<br />the particles are spread nearly over the entire building. This means that<br />the robot at this point does not know it's position and orientation in<br /> 
