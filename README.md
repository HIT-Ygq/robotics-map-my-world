...
| **Different initial start pos**<br />The robot gets placed to another place of the building (left<br />side of the floor),but its orientation keeps the same. In this<br />case, the laser scaner does not match with the walls and the<br />particles are spread nearly over the entire building. This means<br />that the robot at this point does not know it's position and <br />orientation in relation to the building. | <img src="https://github.com/michailtam/where-am-i/blob/master/images/other_initial_start_pos.png" alt="Different initial start pos" width="760" height="250" border="0" /> |
