...
| **Different initial start pos**<br />
The robot gets placed to another place of the building (left<br />side of the floor),but its orientation keeps the same. In this case,<br />the laser scaner does not match with the walls and the particles<br />are spread nearly over the entire building. This means that the<br />robot at this point does not know it's position and orientation in<br />relation to the building. | <img src="https://github.com/michailtam/where-am-i/blob/master/images/other_initial_start_pos.png" alt="Different initial start pos" width="760" height="250" border="0" /> |
