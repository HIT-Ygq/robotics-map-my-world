...
| --- | --- |
| **Initial position and pose**<br/>At startup the robot gets placed at the center of the building<br /> 
(0,0). The blue lines show that the laser scaner and the walls coincide properly. | <img src="https://github.com/michailtam/where-am-i/blob/master/images/initial_pose_and_laser_scan.png" alt="Initial pose & laser scan" width="760" height="250" border="0" /> |
| **Different initial start pos**<br/>The robot gets placed to another<br /> 
place of the building (left side of the floor), but its orientation keeps<br />
the same. In this case, the laser scaner does not match with the walls and<br /> 
the particles are spread nearly over the entire building. This means that<br /> 
the robot at this point does not know it's position and orientation in<br /> 
